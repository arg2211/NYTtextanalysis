...
"""
written by alexstorer & dmil
found here: https://github.com/alexstorer/lexisparse/blob/master/parse.py

type the following into command line once you've set your working directory:

python parse.py -d .\ -b LENGTH None -c NYTtest2.csv -o .\ -m LOAD-DATE LENGTH PUBLICATION-TYPE LANGAUGE SECTION BYLINE PERSON
...
def splitdocs(fullstr,topmarker="BYLINE",bottommarker="LOAD-DATE",colnames=["LENGTH"],dodate=False):
    """
